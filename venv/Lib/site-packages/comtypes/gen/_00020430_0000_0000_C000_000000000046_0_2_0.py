...
__all__ = [ 'IPictureDisp', 'OLE_YPOS_PIXELS', 'Default', 'Picture',
           'OLE_XPOS_CONTAINER', 'OLE_XSIZE_PIXELS', 'Font',
           'OLE_ENABLEDEFAULTBOOL', 'OLE_YSIZE_HIMETRIC',
           'OLE_YSIZE_CONTAINER', 'Gray', 'Monochrome',
           'IFontEventsDisp', 'OLE_XPOS_PIXELS', 'Unchecked',
           'OLE_XSIZE_CONTAINER', 'OLE_XPOS_HIMETRIC', 'FONTBOLD',
           'OLE_YPOS_HIMETRIC', 'IFontDisp', 'OLE_YSIZE_PIXELS',
           'FontEvents', 'FONTSIZE', 'OLE_YPOS_CONTAINER',
           'OLE_COLOR', 'OLE_CANCELBOOL', 'VgaColor', 'FONTNAME',
           'StdPicture', 'FONTSTRIKETHROUGH', 'FONTITALIC', 'Color',
           'OLE_XSIZE_HIMETRIC', 'StdFont', 'IPicture',
           'OLE_TRISTATE', 'OLE_OPTEXCLUSIVE', 'Checked',
           'FONTUNDERSCORE', 'OLE_HANDLE', 'IFont',
